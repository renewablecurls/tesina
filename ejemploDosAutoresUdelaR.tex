...
\documentclass[oneside,a4paper,linenumbers,udelar]{tesina} % version con numeros de linea
...
%  \authort{}{}
  ...
  %
  \cotutor{Dr.Ing.}{Nombres del co tutor/a}{Apellidos del cotutor/a}{(Prof.)}
  %
  ...
  \date{08}{07}{2019} % Fecha del documento.
